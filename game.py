...
class Minesweeper:
    ...
    def initialize_game(self):
        ...
        self.total_mines = 0
        self.current_level = "Easy"  # Default difficulty
        self.mines_to_reveal = []
        self.current_mine_index = 0
        ...
        self.score_buttons = [
            Button(300, 550, 200, 40, "Show Scores"),
            Button(300, 600, 200, 40, "Delete My Data")
        ]
        self.restart_button = Button(550, 60, 100, 40, "Restart")
        self.menu_button = Button(50, 60, 100, 40, "Menu")
    ...
    def start_game(self, level_name):
        if level_name not in DIFFICULTY_LEVELS:
            level_name = "Easy"  # Fallback to Easy if invalid level
